...
export const sheetSources: SheetSource[] = [
  ...
  },
  {
    ...
    group: "Market data",
    description: "One token price in USD, ready to import into a Sheets cell.",
    path: "/cmc/price.csv",
    parameters: [
      {
        key: "coin",
        ...
        kind: "text",
        required: true,
        placeholder: "pax-gold",
        help: "Use BTC, PAXG, MON (Monad), wstETH, a CoinGecko ID, or chain:contract. Prices may be up to an hour old.",
      },
    ],
  },
  {
