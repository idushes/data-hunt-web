...
export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-white/5 pb-20 pt-28 sm:pt-32 lg:pb-28">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
        <div>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-400/20 bg-violet-400/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-violet-200">
            ...
            Personal DeFi tracker · {sheetSources.length} data sources
          </div>

          <h1 className="max-w-2xl text-5xl font-semibold tracking-[-0.06em] text-white sm:text-6xl lg:text-[68px] lg:leading-[1]">
            Track your DeFi positions.
            <span className="mt-2 block text-gradient-primary">In Google Sheets.</span>
          </h1>

          <p className="mt-7 max-w-xl text-xl leading-8 text-zinc-400">
            Keep deposits, debt, APY, rewards, LP positions, and wallet balances
            visible in one spreadsheet.
          </p>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            >
              Track my positions <span className="ml-2">→</span>
            </Link>
            <a
              href="#sources"
        ...
        <div className="relative mx-auto w-full max-w-2xl">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#09090b]/95 shadow-2xl shadow-violet-950/30">
            <div className="flex h-11 items-center gap-2 border-b border-white/10 px-4">
              ...
              <span className="h-2.5 w-2.5 rounded-full bg-zinc-700" />
              <span className="h-2.5 w-2.5 rounded-full bg-zinc-700" />
              <span className="ml-3 font-mono text-[10px] text-zinc-600">My DeFi portfolio / Google Sheets</span>
            </div>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="mt-4 flex items-center gap-3 rounded-xl border border-emerald-400/15 bg-emerald-400/[0.06] p-4">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-semibold text-emerald-200">Live portfolio cell ready</p>
                  <p className="mt-1 truncate font-mono text-[10px] text-zinc-500">=IMPORTDATA(&quot;…/v/8qL2mZ7pR4Kd?auth_token=•••&quot;)</p>
                </div>
              </div>
            </div>
          </div>
